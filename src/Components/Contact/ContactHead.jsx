    ...
    return (
        <RevalonScroll>
            ...
            <section id="home" className="min-h-screen flex flex-col bg-black">
                ...
                <img className="hidden md:block w-full" src="/public/assets/Vector.png" />
                <img className="md:hidden w-full" src="/public/assets/Vector (2).png" />
                ...
                <div className="flex px-16 flex-col items-center md:flex-row justify-between gap-1 w-full mt-10">
                    ...
                    <img className="w-20 md:w-28" src="/public/assets/Circle Button (Desktop).png" />
                </div>
                ...
                <div className="pt-20 w-full flex flex-col md:flex-row justify-around flex-wrap py-12">
                    ...
                    <div className="flex flex-col items-center justify-between px-12 py-12 w-full md:w-[33%] md:h-[520px]">
                        <img className="md:block mb-4" src="/public/assets/1.png" />
                    </div>

                    <div className="flex flex-col items-center justify-between px-12 py-12 w-full md:w-[33%] md:h-[520px]">
                        <img className="hidden md:block mb-4" src="/public/assets/2.png" />
                    </div>
