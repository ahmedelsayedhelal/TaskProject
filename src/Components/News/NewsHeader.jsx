  ...
  return (
      <section className="flex flex-col bg-black mb-40">
        <div className="relative h-[700px] max-h-full  ">
          <div className="w-full flex flex-col md:flex-row md:items-start items-end   py-32  gap-6 md:gap-40 2xl:gap-100 md:px-20 px-8 ">
          ...
          <img className="block  absolute bottom-[12%] md:hidden h-[200px] bg-black w-full " src="/public/assets/Vector (2).png" />
